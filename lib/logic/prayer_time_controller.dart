...
class PrayerTime {
  ...
  Future<Tuple2<StatusEnum, List<String>>> _getZoneList() async {

    // get response from url
    List<String> returnValues = List<String>();
    Response response = await get(_urlMain);
    if (response.statusCode != 200) {
      return Tuple2(StatusEnum.NOT_GOOD, returnValues);
    }
    ...
    return Tuple2(StatusEnum.GOOD, returnValues);
  }

  // private: get zone list
  String _urlData = "https://www.e-solat.gov.my/index.php?r=esolatApi/takwimsolat";
  Future<Tuple2<StatusEnum, List<PrayerTimeData>>> _getZoneData(String period, String zone) async {
